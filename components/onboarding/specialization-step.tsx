...
export function SpecializationStep() {
  ...
  const [selected, setSelected] = useState<string[]>(userData.specializations || [])
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">What do you specialize in?</h1>
        <p className="text-gray-500">
          Select the property types you specialize in. This helps us customize your experience.
        </p>
      </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className={cn(
                      ...
                      selected.includes(spec.id) ? "border-primary bg-primary text-white" : "border-gray-300",
                    )}
                  >
                    {selected.includes(spec.id) && <Check className="h-3 w-3" />}
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="pt-4 flex justify-between">
        ...
        <Button onClick={handleContinue} disabled={selected.length === 0} className="gap-2">
