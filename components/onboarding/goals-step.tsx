...
const goals = [
  {
    ...
    description: "Get tools and insights to help you secure more property listings",
  },
  {
    id: "market-insights",
    label: "Get market insights",
    description: "Stay ahead with real-time data on property trends and competitor activity",
  },
  {
    id: "save-time",
  ...
  },
  {
    ...
    description: "Find opportunities to connect with potential clients and partners",
  },
]
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-gray-500">
          Select what you'd like to achieve with RealtyMate. We'll customize your experience accordingly.
        </p>
      </div>
      ...
      <div className="pt-4 flex justify-between">
        ...
        <Button onClick={handleContinue} disabled={selectedGoals.length === 0} className="gap-2">
