  ...
  return (
    <div className="space-y-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">You're all set, {userData.name}!</h1>
        <p className="text-gray-500">
          Your RealtyMate account has been personalized based on your preferences. You're ready to start gaining a
        ...
        <ul className="text-sm text-blue-700 space-y-2">
          <li className="flex items-start gap-2">
            ...
            <span>
              ...
              {userData.locations.length > 0 ? userData.locations[0] : "your areas"}
            </span>
          </li>
          <li className="flex items-start gap-2">
            <div className="h-5 w-5 rounded-full bg-blue-200 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <span>Try the AI Assistant to get answers about the market and competitor activity</span>
          </li>
          <li className="flex items-start gap-2">
            <div className="h-5 w-5 rounded-full bg-blue-200 flex items-center justify-center flex-shrink-0 mt-0.5">
              <span className="text-blue-800 text-xs font-medium">3</span>
            </div>
            <span>Generate your first AI-powered pitch to win more listings</span>
          </li>
        </ul>
      </div>
