  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Customize your dashboard</h1>
        <p className="text-gray-500">
          Select which widgets you'd like to see on your dashboard. You can always change this later.
        </p>
      </div>
      ...
      <div className="pt-4 flex justify-between">
        ...
        <Button onClick={handleContinue} disabled={selectedWidgets.length === 0} className="gap-2">
