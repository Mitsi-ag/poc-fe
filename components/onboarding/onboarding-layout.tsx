          ...
          <div className="sticky top-8">
              ...
              {steps.map((step, index) => (
                <div
                  ...
                  className={cn(
                    ...
                    currentStep === step.id ? "bg-primary/10 text-primary font-medium" : "text-gray-500",
                  )}
                >
                  <div
                    className={cn(
            ...
            <div className="mt-12 p-4 bg-blue-50 rounded-lg border border-blue-100">
              ...
              <p className="text-xs text-blue-700">
                Contact our support team at <span className="font-medium">support@realtymate.com</span> or call us at{" "}
