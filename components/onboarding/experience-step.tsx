  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">What's your experience level?</h1>
        <p className="text-gray-500">This helps us tailor our AI assistant and tools to your specific needs.</p>
      </div>
      ...
      <div className="pt-4 flex justify-between">
        ...
        <Button onClick={handleContinue} disabled={!experience} className="gap-2">
