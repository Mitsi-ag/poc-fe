    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-semibold tracking-tight">Active Deals</h2>
          <p className="text-sm text-muted-foreground">Track and manage your active property transactions</p>
        </div>
              ...
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src={deal.client.avatar || "/placeholder.svg"} alt={deal.client.name} />
                    <AvatarFallback>
                      {deal.client.name
                        .split(" ")
                        .map((n) => n[0])
                ...
                <div className="flex gap-2">
                  <Badge className={typeColors[deal.type] || ""} variant="outline">
                    {deal.type}
                  </Badge>
