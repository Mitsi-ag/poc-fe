          ...
          <div className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    <FormLabel className="text-base">Outlook Calendar</FormLabel>
                    <FormDescription>Sync your events with Outlook Calendar.</FormDescription>
                  </div>
                  <FormControl>
                    <Switch checked={field.value} onCheckedChange={field.onChange} />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>Sync your events with Apple Calendar.</FormDescription>
                  </div>
                  <FormControl>
                    <Switch checked={field.value} onCheckedChange={field.onChange} />
                  </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>Choose how your calendar is displayed by default.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
            ...
            render={() => (
              <FormItem>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {["15min", "30min", "1hour", "2hours", "1day", "2days"].map((time) => (
                    <FormField
                      key={time}
                      control={form.control}
                      name="reminderTimes"
                      render={({ field }) => {
                        return (
                          <FormItem key={time} className="flex flex-row items-start space-x-3 space-y-0">
                            <FormControl>
                              <Checkbox
                ...
                <FormDescription>Select default reminder times for calendar events.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
