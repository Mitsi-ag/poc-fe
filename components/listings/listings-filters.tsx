...
export function ListingsFilters({ onFilterChange }: ListingsFiltersProps) {
  ...
  const handleFeatureToggle = (feature: string, checked: boolean) => {
    setFilters((prev) => {
      const features = checked ? [...prev.features, feature] : prev.features.filter((f) => f !== feature)
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleFeatureToggle("pool", checked as boolean)}
                />
                <label
                  htmlFor="pool"
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleFeatureToggle("garage", checked as boolean)}
                />
                <label
                  htmlFor="garage"
                  className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleFeatureToggle("aircon", checked as boolean)}
                />
                <label
                  htmlFor="aircon"
                  className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleFeatureToggle("balcony", checked as boolean)}
                />
                <label
                  htmlFor="balcony"
                  className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
