...
const comparisonProperties = [
  ...
  },
  {
    ...
    type: "House",
    yearBuilt: 2005,
    features: ["Garden", "Outdoor Entertainment", "Renovated Kitchen", "Solar Panels"],
  ...
  },
  {
    ...
    type: "Apartment",
    yearBuilt: 2015,
    features: ["Air Conditioning", "Balcony", "City Views", "Security Building"],
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Compare properties side by side to make informed decisions</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="min-w-[800px]">
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="flex flex-col items-center justify-center border-2 border-dashed rounded-lg p-6">
                ...
                <p className="text-sm text-muted-foreground text-center mb-4">Add another property to compare</p>
