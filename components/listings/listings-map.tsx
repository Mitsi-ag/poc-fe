  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-180px)] min-h-[500px] border rounded-lg overflow-hidden">
      ...
      <div className="relative flex-1 bg-gray-100">
        <img src="/sydney-cityscape-map.png" alt="Sydney Map" className="w-full h-full object-cover" />
        ...
        <Button
          ...
          style={{ [showSidebar ? "right" : "left"]: showSidebar ? "-12px" : "8px" }}
      ...
      {showSidebar && (
        <div className="w-full h-[250px] md:h-auto md:w-[400px] bg-background overflow-y-auto">
          <div className="p-3 md:p-4">
            <h3 className="font-medium mb-2 text-sm md:text-base">6 Properties Found</h3>
...
function ListingSidebarCard({ title, address, price, beds, baths, image }: ListingSidebarCardProps) {
  return (
    <Card className="overflow-hidden">
      <div className="flex">
        ...
        <CardContent className="p-3 flex-1">
          ...
          <p className="text-muted-foreground text-xs line-clamp-1 mb-1">{address}</p>
