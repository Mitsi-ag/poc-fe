    ...
    <Card className="border-gray-200 dark:border-gray-800">
      ...
      <CardContent className="grid grid-cols-3 gap-4 pt-0">
        ...
        <div className="space-y-1">
          ...
          <div className={`text-xs flex items-center ${daysChange <= 0 ? "text-green-500" : "text-red-500"}`}>
            {daysChange <= 0 ? <ArrowDownRight className="h-3 w-3 mr-1" /> : <ArrowUpRight className="h-3 w-3 mr-1" />}
        ...
        <div className="space-y-1">
          ...
          <div className={`text-xs flex items-center ${clearanceChange >= 0 ? "text-green-500" : "text-red-500"}`}>
            {clearanceChange >= 0 ? (
