...
import { Bot, FileText, ImageIcon, Send, Settings, X, Copy, Check, Users, BarChart3, Home, Map } from "lucide-react"
    ...
    >
      <Card className="flex flex-col h-full shadow-xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden bg-white/95 backdrop-blur-sm dark:bg-gray-900/95 rounded-2xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
          ...
          <TabsContent value="tools" className="flex-1 flex flex-col mt-0 data-[state=inactive]:hidden">
            <CardContent className="flex-1 overflow-auto p-4">
