...
export function DashboardView() {
  ...
  return (
    <div className="space-y-8 w-full relative">
      ...
      {/* Floating AI Chatbot */}
      {isChatbotOpen && <ChatbotFloating isOpen={isChatbotOpen} onClose={() => setIsChatbotOpen(false)} />}

      {/* Full Page AI Assistant */}
      {isFullPageAssistantOpen && <FullPageAssistant onClose={() => setIsFullPageAssistantOpen(false)} />}
