...
export function ListingPerformance({ timeRange, region }: ListingPerformanceProps) {
        ...
        <CardContent>
          <div className="space-y-6">
            {topListings.map((listing, index) => (
              <div key={index} className="flex flex-col md:flex-row gap-4 border-b pb-4 last:border-0 last:pb-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">{listing.daysListed} days on market</p>
                  <div className="flex gap-4 mt-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-sm">{Math.floor(listing.views * 0.15)}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Share2 className="h-4 w-4 text-muted-foreground" />
                      <span className="text-sm">{Math.floor(listing.views * 0.05)}</span>
                    </div>
                  </div>
                </div>
                <div className="flex flex-row md:flex-col gap-2 items-start">
                  ...
                  <Badge variant="outline">{Math.floor((listing.inquiries / listing.views) * 100)}% Inquiry Rate</Badge>
                </div>
              </div>
            ))}
          </div>
