...
import { ArrowUpRight, ArrowDownRight, Eye, Home, Calendar, MessageSquare } from "lucide-react"
...
export function PerformanceMetrics({ timeRange, region }: PerformanceMetricsProps) {
            ...
            >
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={performanceData}>
                  ...
                  <Bar dataKey="inquiries" fill="var(--color-inquiries)" name="Inquiries" />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
