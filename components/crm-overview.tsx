...
import { ArrowRight, Calendar, Clock, MoreHorizontal, Phone, Plus, Star, Tag, User, Mail } from "lucide-react"
    ...
    <Card className="overflow-hidden bg-white/80 backdrop-blur-sm border shadow-sm hover:shadow-md transition-all dark:bg-gray-900/80">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>Your active leads and opportunities</CardDescription>
          </div>
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input id="name" className="col-span-3" placeholder="Enter lead name" />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="email" className="text-right">
                    Email
                  </Label>
                  <Input id="email" className="col-span-3" placeholder="Enter email address" />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input id="property" className="col-span-3" placeholder="Enter property address" />
                </div>
                <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Textarea id="notes" className="col-span-3" placeholder="Add any additional notes" />
                </div>
              </div>
              <DialogFooter>
                ...
                <Button onClick={() => setShowAddLeadDialog(false)}>Add Lead</Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
        </div>
      ...
      <CardContent className="p-0">
          ...
          <TabsContent value="all" className="m-0">
            <div className="space-y-1 px-2">
              {filteredLeads.map((lead) => (
                <LeadItem key={lead.id} lead={lead} onViewDetails={() => setShowLeadDetails(lead.id)} />
              ))}
            </div>
          </TabsContent>
        ...
        {showLeadDetails !== null && (
          <Dialog open={showLeadDetails !== null} onOpenChange={() => setShowLeadDetails(null)}>
                    ...
                    <div key={lead.id} className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4 mt-4">
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center gap-2 text-sm">
                                ...
                                <span>{lead.name.toLowerCase().replace(" ", ".")}@example.com</span>
                              </div>
                            </div>
                            <div className="space-y-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="rounded-lg border p-3 text-sm">
                          <p>
                            Interested in selling their property in the next 3 months. Currently renovating the
                            bathroom. Concerned about market timing and wants to maximize value. Prefers communication
                            via phone calls.
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="space-y-3">
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1 pb-4">
                              <div className="flex items-center justify-between">
                                <h4 className="text-sm font-medium">Phone Call</h4>
                                <span className="text-xs text-gray-500">2 days ago</span>
                              </div>
                              <p className="text-sm text-gray-600 dark:text-gray-300">
                                Discussed property valuation and market conditions. Client is leaning towards listing in
                                June.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1 pb-4">
                              ...
                              <p className="text-sm text-gray-600 dark:text-gray-300">
                                Sent market report for Bondi Beach with recent comparable sales.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center justify-between">
                                <h4 className="text-sm font-medium">Initial Contact</h4>
                                <span className="text-xs text-gray-500">2 weeks ago</span>
                              </div>
                              <p className="text-sm text-gray-600 dark:text-gray-300">
                                Met at open house for 18 Palm St. Expressed interest in selling their own property.
                              </p>
                            </div>
                          </div>
                        </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        >
          <Star className={cn("h-4 w-4", isPriority && "fill-yellow-400 text-yellow-400")} />
        </Button>
        <Button
          variant="ghost"
          size="icon"
