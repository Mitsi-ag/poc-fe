...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
        ...
        <div className="flex-1 flex flex-col">
          <header
            className={cn(
              ...
              scrolled ? "bg-white/80 backdrop-blur-md border-b shadow-sm dark:bg-gray-900/80" : "bg-transparent",
            )}
          >
      ...
      <ChatbotFloating isOpen={isChatOpen} onClose={() => setIsChatOpen(false)} />
    </SidebarProvider>
  )
}
  ...
  return (
    <Sidebar variant="floating" className="border-0">
      ...
      <SidebarContent>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/"} className="group transition-all">
              <Link href="/">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/listings"} className="group transition-all">
              <Link href="/listings">
                <div className="absolute left-0 h-8 w-1 rounded-r-full bg-blue-500 opacity-0 transition-opacity group-hover:opacity-100 group-data-[active=true]:opacity-100" />
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/competitors"} className="group transition-all">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/ai-assistant"} className="group transition-all">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/pitch-builder"} className="group transition-all">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/crm"} className="group transition-all">
              <Link href="/crm">
                <div className="absolute left-0 h-8 w-1 rounded-r-full bg-blue-500 opacity-0 transition-opacity group-hover:opacity-100 group-data-[active=true]:opacity-100" />
                <Users className="h-5 w-5" />
                <span>CRM</span>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/ai-tools"} className="group transition-all">
              <Link href="/ai-tools">
                <div className="absolute left-0 h-8 w-1 rounded-r-full bg-blue-500 opacity-0 transition-opacity group-hover:opacity-100 group-data-[active=true]:opacity-100" />
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/calendar"} className="group transition-all">
              <Link href="/calendar">
                <div className="absolute left-0 h-8 w-1 rounded-r-full bg-blue-500 opacity-0 transition-opacity group-hover:opacity-100 group-data-[active=true]:opacity-100" />
      ...
      <SidebarFooter>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild isActive={pathname === "/settings"} className="group transition-all">
              <Link href="/settings">
                <div className="absolute left-0 h-8 w-1 rounded-r-full bg-blue-500 opacity-0 transition-opacity group-hover:opacity-100 group-data-[active=true]:opacity-100" />
