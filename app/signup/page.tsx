        ...
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            <div className="relative h-8 w-8 overflow-hidden rounded-full bg-white">
              <div className="absolute inset-0 flex items-center justify-center text-blue-500 font-bold">RM</div>
            </div>
            <span className="font-bold text-xl text-white">RealtyMate</span>
          </Link>
      ...
      <main className="flex-1 container mx-auto flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <Card className="border-0 shadow-xl">
            <CardHeader className="space-y-1">
              <div className="flex items-center">
                {step === 2 && (
                  <Button variant="ghost" size="sm" className="mr-2 h-8 w-8 p-0" onClick={() => setStep(1)}>
              ...
              <CardDescription>
                {step === 1 ? "Enter your information to get started" : "Tell us about your business"}
              </CardDescription>
            </CardHeader>
          ...
          <div className="mt-6 text-center text-white">
            <p className="text-lg font-medium">No credit card required. Free 14-day trial. Cancel anytime.</p>
