...
export async function GET(request: Request) {
  ...
  if (agencyId) {
    filteredContacts = filteredContacts.filter((contact) => contact.agencyId === agencyId)
  }
  ...
  if (stage) {
    filteredContacts = filteredContacts.filter((contact) => contact.stage === stage)
  }
  ...
  if (tag) {
    filteredContacts = filteredContacts.filter((contact) => contact.tags.some((t) => t === tag))
  }
