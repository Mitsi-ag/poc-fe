...
const locationDatabase: Record<string, LocationData> = {
  ...
  canberra: {
    state: "ACT",
    description: "Canberra, Australia's capital, is a planned city with national museums, galleries, and monuments.",
    population: 431000,
    medianPrice: 830000,
...
export async function getSuburbData(suburb: string, location: string): Promise<SuburbData> {
  // In a real app, this would fetch from an API or database
