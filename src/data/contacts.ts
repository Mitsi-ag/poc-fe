...
export const contacts: Contact[] = [
  {
    ...
    postcode: "2042",
    notes:
      "Looking for a 3-bedroom family home with a garden in the Inner West.",
    source: "website",
    stage: "lead",
    assignedTo: "u-001",
    agencyId: "ag-001",
    ...
    history: [
      ...
      },
      {
        ...
        type: "call",
        description:
          "Called to discuss requirements. Confirmed budget and location preferences.",
      },
      {
        id: "h-001-3",
        ...
        type: "property-view",
        description:
          "Showed property at 42 Oxford Street, Newtown. Liked the layout but concerned about road noise.",
        listingId: "l-012",
      },
    ],
  ...
  },
  {
    ...
    postcode: "2026",
    notes:
      "Considering selling her apartment in early 2024. Looking for a quick sale with minimal hassle.",
    source: "referral",
    stage: "prospect",
    assignedTo: "u-002",
    agencyId: "ag-001",
    ...
    history: [
      ...
      },
      {
        ...
        type: "meeting",
        description:
          "Initial meeting at her property. Apartment is in good condition, 2-bed with ocean views.",
      },
      {
        id: "h-002-3",
  ...
  },
  {
    ...
    postcode: "2067",
    notes:
      "Property investor with multiple apartments in North Sydney area. Looking for property management services.",
    source: "direct",
    stage: "client",
    assignedTo: "u-003",
    agencyId: "ag-002",
    ...
    history: [
      ...
      },
      {
        ...
        type: "note",
        description:
          "Signed property management agreement for 2 properties in North Sydney.",
      },
      {
        id: "h-003-4",
  ...
  },
  {
    ...
    postcode: "2029",
    notes:
      "Looking for a high-end apartment with water views. Budget not an issue for the right property.",
    source: "social-media",
    stage: "prospect",
    assignedTo: "u-004",
    agencyId: "ag-002",
    ...
    history: [
      ...
      },
      {
        ...
        type: "call",
        description:
          "Discussed requirements and arranged to show off-market listings.",
      },
      {
        id: "h-004-3",
        ...
        type: "property-view",
        description:
          "Showed 3 properties in Point Piper. Particularly interested in the penthouse on Wolseley Road.",
        listingId: "l-037",
      },
    ],
  ...
  },
  {
    ...
    phone: "0416 789 012",
    notes:
      "Looking for a 2-bedroom apartment to rent in Surry Hills or Darlinghurst. Budget $750-850 per week.",
    source: "portal",
    stage: "lead",
    assignedTo: "u-005",
    agencyId: "ag-003",
    ...
    history: [
      ...
      },
      {
        ...
        type: "call",
        description:
          "Discussed requirements and available properties. Will send suitable listings.",
      },
    ],
