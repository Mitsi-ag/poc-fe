    ...
    topAgents: [
      {
        name: "James Wilson",
        photo:
          "/placeholder.svg?height=100&width=100&query=real+estate+agent+professional",
      ...
      },
      {
        ...
        photo:
          "/placeholder.svg?height=100&width=100&query=female+real+estate+agent+professional",
    ...
    topAgents: [
      {
        name: "Olivia Chen",
        photo:
          "/placeholder.svg?height=100&width=100&query=asian+female+real+estate+agent",
    ...
    topAgents: [
      {
        name: "David Thompson",
        photo:
          "/placeholder.svg?height=100&width=100&query=male+beach+real+estate+agent",
      ...
      },
      {
        name: "Sarah Miller",
        photo:
          "/placeholder.svg?height=100&width=100&query=professional+female+beach+real+estate+agent",
