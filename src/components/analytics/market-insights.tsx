      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Median and average property prices (Sample data)
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Average days properties stay listed (Sample data)
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Breakdown by property type (Sample data)
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Areas with highest price growth (Sample data)
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {hotSuburbs.map((suburb, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        suburb.volume === "High" ? "default" : "secondary"
                      }
                      className="text-xs"
                    >
                      {suburb.volume}
