        ...
        <div className="space-y-4">
          <div className="flex gap-3">
            <Avatar className="h-8 w-8">
              <AvatarImage
                src="/placeholder.svg?height=32&width=32&query=AI assistant"
                alt="AI"
              />
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="bg-muted rounded-lg rounded-tl-none p-3 text-sm">
                ...
                <ol className="mt-2 ml-4 list-decimal">
                  ...
                  <li>
                    David Thompson (LJ Hooker) - 5 new listings, 64% clearance
                    rate
                  </li>
                  <li>
                    James Wilson (McGrath) - 4 new listings, 70% clearance rate
                  </li>
                </ol>
