        ...
        <TabsContent value="preferences" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review and update your preferences to personalize your
                RealtyMate experience
              </CardDescription>
            </CardHeader>
            <CardContent>
              <UserPreferencesForm
        ...
        <TabsContent value="calendar" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your calendar integrations and settings
              </CardDescription>
            </CardHeader>
            <CardContent>
              <CalendarSettings />
        ...
        <TabsContent value="integrations" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Connect RealtyMate with other tools and services
              </CardDescription>
            </CardHeader>
            <CardContent>
              <IntegrationsView />
