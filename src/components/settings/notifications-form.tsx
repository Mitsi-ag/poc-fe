              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Receive alerts when new properties are listed in your
                      areas.
                    </FormDescription>
                  </div>
                  <FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Get updates on competitor listings and sales.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Receive immediate notifications for new leads.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
          ...
          render={() => (
            <FormItem>
              <div className="mb-4">
                ...
                <FormDescription>
                  Select the ways you want to receive notifications.
                </FormDescription>
              </div>
