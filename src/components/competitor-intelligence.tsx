...
export function CompetitorIntelligence() {
  ...
  const [showPitchGenerator, setShowPitchGenerator] = useState<number | null>(
    null,
  );
  ...
  const filteredCompetitors = competitorData.filter((competitor) => {
    ...
    const matchesSuburb =
      ...
      competitor.primarySuburb
        .toLowerCase()
        .includes(selectedSuburb.toLowerCase());
                ...
                <CardFooter className="flex justify-between pt-0 pb-3">
                  ...
                  <div className="flex gap-1">
                    <Dialog
                      ...
                      onOpenChange={(open) =>
                        setShowAgentProfile(open ? agent.id : null)
                      }
                    >
                                ...
                                <div className="space-y-2">
                                  <div className="rounded-md border p-2 text-sm">
                                    <div className="font-medium">
                                      New Listing: 45 Beach Road, Bondi
                                    </div>
                                    <div className="text-xs text-gray-500">
                                      2 days ago • $1.8M-$2M
                                    </div>
                                  ...
                                  <div className="rounded-md border p-2 text-sm">
                                    <div className="font-medium">
                                      Price Change: 12 Ocean View, Coogee
                                    </div>
                                    <div className="text-xs text-gray-500">
                                      5 days ago • -$50,000
                                    </div>
                    ...
                    >
                      ...
                      <DialogContent className="sm:max-w-[700px]">
                        <DialogHeader>
                          <DialogTitle>
                            Generate Pitch Against {agent.name}
                          </DialogTitle>
                          <DialogDescription>
                            Create a compelling pitch to win listings against
                            this competitor
                          </DialogDescription>
                        </DialogHeader>
